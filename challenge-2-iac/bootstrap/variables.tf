...
variable "ctf_domain" {
  type        = string
  description = "Dedicated domain for Challenge 2 (e.g. \"ctf-shadow-pipeline.example.com\"). Per-team Forgejo instances are published at <team_id>.<ctf_domain>. A wildcard ACM cert and shared ALB are provisioned for *.<ctf_domain>."
}
