# Challenge 3 shared bootstrap — apply this ONCE, before any team's per-team stack
# (challenge-3-iac/main.tf) is applied. Every resource here is referenced back by the
...
resource "aws_security_group" "alb_sg" {
  ...
  description = "Allow public HTTP/HTTPS to the shared Challenge 3 ALB"
...
# challenge-3-iac/main.tf) take priority over this default and route each
...
# looked up read-only by the per-team stack — see challenge-3-iac/forgejo/README.md).
